...
$AllowedFiles = @('.env.example', 'Dockerfile', 'LICENSE', 'README.md', 'VERSION', 'docker-compose.yml', 'pyproject.toml', 'requirements.lock', 'setup.bat', 'start-system.bat', 'stop-system.bat')
